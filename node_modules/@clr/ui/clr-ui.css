...
.clr-form-horizontal .clr-form-control.clr-form-control-multi .clr-control-label {
  width: 8rem;
  -ms-flex-negative: 0;
  flex-shrink: 0; }

.clr-form-horizontal.row .clr-control-label {
  width: auto; }
...
.clr-radio-wrapper {
  ...
  .clr-radio-wrapper.disabled input[type='radio']:checked + label::before {
    background-color: #ccc;
    box-shadow: inset 0 0 0 0.25rem #0079b8; }
  .clr-radio-wrapper.clr-radio-inline {
    display: -ms-flexbox;
    display: flex;
    -ms-flex-wrap: wrap;
    flex-wrap: wrap;
    -ms-flex-line-pack: start;
    align-content: flex-start; }
    .clr-radio-wrapper.clr-radio-inline .clr-control-label {
      display: inline-block;
      margin-right: 0.5rem;
      width: auto; }
